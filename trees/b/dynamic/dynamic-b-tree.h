 ...
 * Dynamic B tree.
 *
 * It's used the terminology of 'order' defined by Cormem, i.e., order as the minimum number of children pointers that every B tree node can have.
 * It's allowed duplicate keys.
 */
#include <stdio.h>
#include <stdlib.h>
#include <stdbool.h>
