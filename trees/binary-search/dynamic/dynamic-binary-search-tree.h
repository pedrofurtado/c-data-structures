...
BINARY_SEARCH_TREE_NODE** binary_search_tree_pre_order(BINARY_SEARCH_TREE_NODE* root);
BINARY_SEARCH_TREE_NODE** binary_search_tree_in_order(BINARY_SEARCH_TREE_NODE* root);
BINARY_SEARCH_TREE_NODE** binary_search_tree_post_order(BINARY_SEARCH_TREE_NODE* root);
BINARY_SEARCH_TREE_NODE** binary_search_tree_level_order(BINARY_SEARCH_TREE_NODE* root);
